        ...
        <>
          <div className="mb-6 border-b border-gray-200">
            <nav className="-mb-px flex space-x-8">
              ...
              <button
                ...
                className={`py-4 px-1 border-b-2 font-medium text-sm ${activeTab === 'layout'
                  ? 'border-pink-500 text-pink-600'
                  : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'
                  }`}
              >
            ...
            activeTab === 'layout' && (
              <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-200 overflow-x-auto">
                <div className="mb-4 flex items-center gap-4">
                  <label className="text-sm font-medium text-gray-700">Canvas Height (px):</label>
                  <input
                    type="number"
                    min="600"
                    max="2000"
                  ...
                  />
                  <span className="text-xs text-gray-500">Increase height to add more slots</span>
                </div>
                <TemplateCanvas
                  slots={layoutSlots}
          ...
          <div className="mt-8 flex justify-end gap-4">
            ...
            <button
              onClick={handleSubmit}
              disabled={loading}
              className="px-8 py-3 bg-gradient-to-r from-pink-500 to-rose-500 text-white rounded-lg hover:from-pink-600 hover:to-rose-600 disabled:opacity-50 transition-all shadow-lg transform hover:scale-105"
            >
              {loading ? 'Saving...' : (isEditMode ? 'Update Template' : 'Create Template')}
            </button>
          </div>
